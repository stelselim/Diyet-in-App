...
class HighCalorie extends StatefulWidget {
  HighCalorie({Key key}) : super(key: key);

  @override
  _HighCalorieState createState() => _HighCalorieState();
}

class _HighCalorieState extends State<HighCalorie> {
  Firestore firestoreHighCalorie = Firestore.instance;
  dynamic _highCalorie;
                ...
                SizedBox(
                  child: StreamBuilder<QuerySnapshot>(
                      stream: Firestore.instance
                          .collection(
                              "/BeslenmeApp/AllDatas/Tarifler/Kategoriler/YüksekKalorili")
                          .getDocuments()
                          .asStream(),
...
Widget cardHighCalorie(DocumentSnapshot doc, BuildContext context, var data,
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            /* Row(
                              ...
                              children: <Widget>[
                                Text("Devam et",style: styleOfMacros,),
                                SizedBox(
                                  width: 4,
                                ),
