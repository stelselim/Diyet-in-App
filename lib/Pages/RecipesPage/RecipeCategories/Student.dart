...
class _StudentState extends State<Student> {
  dynamic _studentRecipe;
  Firestore firestoreStudent = Firestore.instance;
                ...
                SizedBox(
                  child: StreamBuilder<QuerySnapshot>(
                      stream: Firestore.instance
                          .collection(
                              "/BeslenmeApp/AllDatas/Tarifler/Kategoriler/ÖğrencilereÖzel")
                          .getDocuments()
                          .asStream(),
...
// Global Yapılacak Her bir kart için
Widget cardStudent(DocumentSnapshot doc, BuildContext context, var data,
