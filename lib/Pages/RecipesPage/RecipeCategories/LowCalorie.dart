...
class LowCalorie extends StatefulWidget {
  LowCalorie({Key key}) : super(key: key);

  @override
  _LowCalorieState createState() => _LowCalorieState();
}

class _LowCalorieState extends State<LowCalorie> {
  Firestore firestoreLowCalorie = Firestore.instance;
  dynamic _lowCalorieRecipe;
                ...
                SizedBox(
                  child: StreamBuilder<QuerySnapshot>(
                      stream: Firestore.instance
                          .collection(
                              "/BeslenmeApp/AllDatas/Tarifler/Kategoriler/DüşükKalorili")
                          .getDocuments()
                          .asStream(),
...
Widget cardLowCalorie(DocumentSnapshot doc, BuildContext context, var data,
